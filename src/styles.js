...
export const css = {
  ...
  pageTitle:{fontFamily:"Georgia,serif",fontSize:"clamp(24px, 2.6vw, 36px)",lineHeight:1.04,fontWeight:600,margin:0,color:INK,letterSpacing:0,maxWidth:760},
  ...
  exploreGrid:{padding:"6px 18px 12px",
    display:"grid",
  ...
  exploreCard:(card)=>({
    ...
    boxShadow:"0 6px 16px rgba(23,20,18,.05)",
    cursor:"pointer",
    fontFamily:"inherit",
    textAlign:"left",
  ...
  exploreIcon:(color)=>({
    ...
    fontSize:16,
    fontWeight:700,
    boxShadow:`0 5px 12px ${color}40`
  }),
  exploreContent:{display:"flex",flexDirection:"column",gap:1,minWidth:0},
  exploreKicker:{fontSize:9.5,letterSpacing:".1em",textTransform:"uppercase",color:"rgba(23,20,18,.46)",fontWeight:600},
  exploreTitle:{fontFamily:"Georgia,serif",fontSize:16,lineHeight:1.1,color:INK},
  exploreText:{fontSize:10,lineHeight:1.35,color:MUTED,overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},
